...
export default function MoltenMetal({
  ...
  useEffect(() => {
    ...
    // Background layers sit under UI — never steal clicks; track mouse on window instead
    ...
    // Updated by the props sync effect — setup effect only mounts once
    const mouseEnabled = { current: true };
    ctxMap.set(container, { renderer, program, mesh, mouseEnabled });
    ...
    const handleMouseMove = (e) => {
      ...
      // Still respond when cursor is over hero content above this layer
  ...
  useEffect(() => {
    ...
    ctx.mouseEnabled.current = mouseInteraction;
