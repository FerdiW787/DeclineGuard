...
function TooltipBoxInner({
  ...
  const panelClassName = cn(
    "min-w-[140px] overflow-hidden rounded-lg border border-black/8 text-chart-tooltip-foreground shadow-[0_12px_40px_-16px_rgba(0,0,0,0.28)] dark:border-white/10",
