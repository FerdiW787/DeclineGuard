...
const DateTickerCompact = memo(function DateTickerCompact({
  ...
  return (
    <div className="overflow-hidden rounded-full border border-black/8 bg-white px-4 py-1 text-zinc-900 shadow-lg dark:border-white/10 dark:bg-zinc-900 dark:text-white">
